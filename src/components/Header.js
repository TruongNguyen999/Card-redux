            ...
            <header>
                    <ul id="slide-out" className="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default" data-ps-id="c27390a3-9efc-e0d8-197a-ab96d73a156a">
                        ...
                        <li>
                            <ul className="social">
                                <li>
                                    <a className="icons-sm fb-ic" href="true">
                                        <i className="fa fa-facebook"> </i>
                                    </a>
                                </li>
                                <li>
                                    <a className="icons-sm pin-ic" href="true">
                                        <i className="fa fa-pinterest"> </i>
                                    </a>
                                </li>
                                <li>
                                    <a className="icons-sm gplus-ic" href="true">
                                        <i className="fa fa-google-plus"> </i>
                                    </a>
                                </li>
                                <li>
                                    <a className="icons-sm tw-ic" href="true">
                        ...
                        <li>
                            ...
                            <ul className="collapsible collapsible-accordion">
                                <li>
                                    <a className="collapsible-header waves-effect arrow-r" href="true">
                                ...
                                <li className="active">
                                    <a className="collapsible-header waves-effect arrow-r active" href="true">
                    ...
                    <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                        ...
                        <div className="float-left">
                            <a data-activates="slide-out" className="button-collapse" href='true'>
